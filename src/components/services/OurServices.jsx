  ...
  return (
    <section className=" w-full py-16 px-4 md:px-16">
      <div className="max-w-7xl mx-auto text-center">
        <p className="text-[#00a4f0] font-bold text-lg tracking-wide mb-2">Our Services</p>
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
          We provide a wide range of creative services
        </h2>
        <p className="text-gray-600 max-w-2xl mx-auto mb-12">
          We offer a full spectrum of technology services to help businesses stay competitive,
          connected, and future-ready. Whether you're a startup or a growing enterprise,
          KiteCareer delivers smart solutions that scale with your vision.
        </p>
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
  {services.map((item, index) => {
    ...
    return (
      <div
        key={index}
        className={`mx-auto w-full sm:w-[90%] lg:w-[85%] xl:w-[80%] 2xl:w-[75%] px-6 py-10 transition-all duration-300 hover:shadow-xl hover:scale-[1.03] flex flex-col items-center text-center ${isHovered ? 'text-white' : 'text-black'
          }`}
        style={{
      ...
      >
        <div
          className={`w-14 h-14 mb-4 rounded-full border-4 flex items-center justify-center transition-all duration-300 ${isHovered
